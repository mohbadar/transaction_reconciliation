...
import com.tutuka.lib.lang.validation.constraints.ValidIdentifier;
...
public class CheckIdentifier implements ConstraintValidator<ValidIdentifier, String> {
   ...
   static boolean validate(final String obj, final long maximumLength) {
      if (obj.length() < 2)
         return false;
