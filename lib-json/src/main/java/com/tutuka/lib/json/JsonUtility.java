package com.tutuka.lib.json;

import com.tutuka.lib.lang.exception.common.IOException;
import com.tutuka.lib.json.util.JsonUtilConstants;
import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.SerializationFeature;
import com.tutuka.lib.json.exception.JsonMappingException;
import com.tutuka.lib.json.exception.JsonParseException;
import com.tutuka.lib.json.exception.JsonProcessingException;
...
public class JsonUtility {
	...
	/*public static boolean javaObjectToJsonFile(Object className, String location)
		...
		try {
			...
			throw new JsonGenerationException(JsonUtilConstants.JSON_GENERATION_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.JSON_GENERATION_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (com.fasterxml.jackson.databind.JsonMappingException e) {
			throw new JsonMappingException(JsonUtilConstants.JSON_MAPPING_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.JSON_MAPPING_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (java.io.IOException e) {
			throw new IOException(JsonUtilConstants.IO_EXCEPTION_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.IO_EXCEPTION_ERROR_CODE.getErrorMessage(), e.getCause());
		}
		return (file.exists());
	...
	public static String javaObjectToJsonString(Object className) throws JsonProcessingException {
		...
		try {
			...
			throw new JsonProcessingException(JsonUtilConstants.JSON_PROCESSING_EXCEPTION.getErrorCode(),
					JsonUtilConstants.JSON_PROCESSING_EXCEPTION.getErrorMessage(), e.getCause());
		}
	...
	public static Object jsonStringToJavaObject(Class<?> className, String jsonString)
		...
		try {
			...
			throw new JsonParseException(JsonUtilConstants.JSON_PARSE_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.JSON_PARSE_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (com.fasterxml.jackson.databind.JsonMappingException e) {
			throw new JsonMappingException(JsonUtilConstants.JSON_MAPPING_ERROR_CODE.getErrorCode(),
					JsonUtilConstants.JSON_MAPPING_ERROR_CODE.getErrorMessage(), e.getCause());
		} catch (java.io.IOException e) {
